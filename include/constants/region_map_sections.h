...
#define MAPSEC_ROUTE_B                      0xE0
#define MAPSEC_ROUTE_C                      0xE1
#define MAPSEC_ROUTE_D                      0xE2
#define MAPSEC_ROUTE_E                      0xE3
#define MAPSEC_ROUTE_F                      0xE4
#define MAPSEC_ROUTE_G                      0xE5
#define MAPSEC_ROUTE_H                      0xE6
#define MAPSEC_ROUTE_I                      0xE7
#define MAPSEC_ROUTE_J                      0xE8
#define MAPSEC_ROUTE_K                      0xE9
#define MAPSEC_SODORI_TUNNELS               0xF0
#define MAPSEC_KEREN_TUNNELS                0xF1
#define MAPSEC_KEREN_CAVE                   0xF2
#define MAPSEC_KENKORIA_SEA                 0xF3
#define MAPSEC_KENKORIA_SAFARI_ZONE         0xF4
#define MAPSEC_PEAKS_OF_ARBEL               0xF5
#define MAPSEC_MEDIAN_SEA                   0xF6
#define MAPSEC_DEAD_SEA                     0xF7
