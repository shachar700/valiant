...
const u32 gItemIcon_HappyMeal[] = INCBIN_U32("graphics/items/icons/happy_meal.4bpp.lz");
const u32 gItemIconPalette_HappyMeal[] = INCBIN_U32("graphics/items/icon_palettes/happy_meal.gbapal.lz");
