static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_HAWAM_CITY - 1] = {MAP_GROUP(HAWAM_CITY), MAP_NUM(HAWAM_CITY), 37, 30},
    [HEAL_LOCATION_PTOLEMAIS_CITY - 1] = {MAP_GROUP(PTOLEMAIS_CITY), MAP_NUM(PTOLEMAIS_CITY), 25, 29},
};
