static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SHESH_BESH_CITY - 1] = {MAP_GROUP(SHESH_BESH_CITY), MAP_NUM(SHESH_BESH_CITY), 32, 27},
    [HEAL_LOCATION_MEDIAN_SEA_SOUTH - 1] = {MAP_GROUP(MEDIAN_SEA_SOUTH), MAP_NUM(MEDIAN_SEA_SOUTH), 40, 20},
    [HEAL_LOCATION_MEDIAN_SEA_WEST - 1] = {MAP_GROUP(MEDIAN_SEA_WEST), MAP_NUM(MEDIAN_SEA_WEST), 20, 36},
    [HEAL_LOCATION_MEDIAN_SEA_NORTH - 1] = {MAP_GROUP(MEDIAN_SEA_NORTH), MAP_NUM(MEDIAN_SEA_NORTH), 47, 20},
