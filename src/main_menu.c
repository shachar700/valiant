...
static const u8 *const sMalePresetNames[] = {
    COMPOUND_STRING("BAR"),
    COMPOUND_STRING("YOAV"),
    COMPOUND_STRING("TOMER"),
    COMPOUND_STRING("GUY"),
    COMPOUND_STRING("YUVAL"),
    COMPOUND_STRING("ORI"),
    COMPOUND_STRING("OFEK"),
    COMPOUND_STRING("NOAM"),
    COMPOUND_STRING("DOR"),
    COMPOUND_STRING("TAL"),
    COMPOUND_STRING("SHAHAR"),
    COMPOUND_STRING("URI"),
    COMPOUND_STRING("ARIEL"),
    COMPOUND_STRING("DAVID"),
    COMPOUND_STRING("EITAN"),
    COMPOUND_STRING("OMER"),
    COMPOUND_STRING("NOAM"),
    COMPOUND_STRING("DANIEL"),
    COMPOUND_STRING("RON"),
    COMPOUND_STRING("NIMROD")
};

static const u8 *const sFemalePresetNames[] = {
    COMPOUND_STRING("MAYA"),
    COMPOUND_STRING("NETA"),
    COMPOUND_STRING("TAMAR"),
    COMPOUND_STRING("NOA"),
    COMPOUND_STRING("YAEL"),
    COMPOUND_STRING("REUT"),
    COMPOUND_STRING("SARAH"),
    COMPOUND_STRING("DALIA"),
    COMPOUND_STRING("SHARON"),
    COMPOUND_STRING("SHIR"),
    COMPOUND_STRING("RONI"),
    COMPOUND_STRING("HADAR"),
    COMPOUND_STRING("ADI"),
    COMPOUND_STRING("YARDEN"),
    COMPOUND_STRING("INBAR"),
    COMPOUND_STRING("ORIT"),
    COMPOUND_STRING("KEREN"),
    COMPOUND_STRING("EDEN"),
    COMPOUND_STRING("TZLIL"),
    COMPOUND_STRING("ANAT")
};
