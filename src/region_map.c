...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_HARU_TEL_CITY] = {MAP_GROUP(HARU_TEL_CITY), MAP_NUM(HARU_TEL_CITY), HEAL_LOCATION_HARU_TEL_CITY},
    [MAPSEC_JEBUS_CITY] = {MAP_GROUP(JEBUS_CITY), MAP_NUM(JEBUS_CITY), HEAL_LOCATION_JEBUS_CITY},
    [MAPSEC_GOLIATH_CITY] = {MAP_GROUP(GOLIATH_CITY), MAP_NUM(GOLIATH_CITY), HEAL_LOCATION_GOLIATH_CITY},
    [MAPSEC_SHESHBESH_CITY] = {MAP_GROUP(SHESH_BESH_CITY), MAP_NUM(SHESH_BESH_CITY), HEAL_LOCATION_SHESH_BESH_CITY},
    [MAPSEC_TAMARIX_CITY] = {MAP_GROUP(TAMARIX_CITY), MAP_NUM(TAMARIX_CITY), HEAL_LOCATION_TAMARIX_CITY},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_PTOLEMAIS_CITY:
        return FlagGet(FLAG_VISITED_PTOLEMAIS_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_KEREN_CITY:
        return FlagGet(FLAG_VISITED_KEREN_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_KENKORIA_CITY:
        return FlagGet(FLAG_VISITED_KENKORIA_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_HARU_TEL_CITY:
        return FlagGet(FLAG_VISITED_HARU_TEL_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_JEBUS_CITY:
        return FlagGet(FLAG_VISITED_JEBUS_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GOLIATH_CITY:
        return FlagGet(FLAG_VISITED_GOLIATH_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SHESHBESH_CITY:
        return FlagGet(FLAG_VISITED_SHESH_BESH_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_TAMARIX_CITY:
        return FlagGet(FLAG_VISITED_TAMARIX_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
