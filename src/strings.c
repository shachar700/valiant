...
const u8 gText_ExpandedPlaceholder_Magma[] = _("SMASH");
...
const u8 gText_DefaultNameStu[] = _("BAR");
const u8 gText_DefaultNameMilton[] = _("YOAV");
const u8 gText_DefaultNameTom[] = _("TOMER");
const u8 gText_DefaultNameKenny[] = _("GUY");
const u8 gText_DefaultNameReid[] = _("YUVAL");
const u8 gText_DefaultNameJude[] = _("ORI");
const u8 gText_DefaultNameJaxson[] = _("OFEK");
const u8 gText_DefaultNameEaston[] = _("NOAM");
const u8 gText_DefaultNameWalker[] = _("DOR");
const u8 gText_DefaultNameTeru[] = _("TAL");
const u8 gText_DefaultNameJohnny[] = _("SHAHAR");
const u8 gText_DefaultNameBrett[] = _("URI");
const u8 gText_DefaultNameSeth[] = _("ARIEL");
const u8 gText_DefaultNameTerry[] = _("DAVID");
const u8 gText_DefaultNameCasey[] = _("EITAN");
const u8 gText_DefaultNameDarren[] = _("LEVI");
const u8 gText_DefaultNameLandon[] = _("SHAI");
const u8 gText_DefaultNameCollin[] = _("DANIEL");
const u8 gText_DefaultNameStanley[] = _("RON");
const u8 gText_DefaultNameQuincy[] = _("REFAEL");
const u8 gText_DefaultNameKimmy[] = _("MAYA");
const u8 gText_DefaultNameTiara[] = _("NETA");
const u8 gText_DefaultNameBella[] = _("TAMAR");
const u8 gText_DefaultNameJayla[] = _("NOA");
const u8 gText_DefaultNameAllie[] = _("YAEL");
const u8 gText_DefaultNameLianna[] = _("REUT");
const u8 gText_DefaultNameSara[] = _("SARAH");
const u8 gText_DefaultNameMonica[] = _("DALIA");
const u8 gText_DefaultNameCamila[] = _("SHARON");
const u8 gText_DefaultNameAubree[] = _("SHIR");
const u8 gText_DefaultNameRuthie[] = _("RONI");
const u8 gText_DefaultNameHazel[] = _("HADAR");
const u8 gText_DefaultNameNadine[] = _("YARDEN");
const u8 gText_DefaultNameTanja[] = _("INBAR");
const u8 gText_DefaultNameYasmin[] = _("ORIT");
const u8 gText_DefaultNameNicola[] = _("CHEN");
const u8 gText_DefaultNameLillie[] = _("KEREN");
const u8 gText_DefaultNameTerra[] = _("TZLIL");
const u8 gText_DefaultNameLucy[] = _("EDEN");
const u8 gText_DefaultNameHalie[] = _("ANAT");
...
const u8 gText_DexHoenn[] = _("WORLD");
...
// Repel Question options
const u8 gText_ans500[] = _("500");
const u8 gText_ans550[] = _("550");
const u8 gText_ans600[] = _("600");
const u8 gText_ans750[] = _("750");
